...
name_dict = OrderedDict((
    ...
    ('g 15.*', ('00F10', '00008000')),
    ('g 14.RAD *', ('00F10', '00004000')),
    ('g 13.BLU *', ('00F10', '00002000')),
    ('g 12.EM_BAT', ('00F10', '00001000')),
    ('g 11.BBC1', ('00F10', '00000800')),
    ('g 10.BBC0', ('00F10', '00000400')),
    ('g 9.', ('00F10', '00000200')),
    ('g 8.', ('00F10', '00000100')),
    ('g 7.', ('00F10', '00000080')),
    ('g 6.IMUC0', ('00F10', '00000040')),
    ('g 5.DINT', ('00F10', '00000020')),
    ('g 4.', ('00F10', '00000010')),
    ('g 3.BMS2', ('00F10', '00000008')),
    ('g 2.BMS1', ('00F10', '00000004')),
    ('g 1.BMS0', ('00F10', '00000002')),
    ('g 0.COORD', ('00F10', '00000001')),
    ('m 15.*', ('00F20', '00008000')),
    ('m 14.RAD *', ('00F20', '00004000')),
    ('m 13.BLU *', ('00F20', '00002000')),
    ('m 12.EM_BAT', ('00F20', '00001000')),
    ('m 11.BBC1', ('00F20', '00000800')),
    ('m 10.BBC0', ('00F20', '00000400')),
    ('m 9.', ('00F20', '00000200')),
    ('m 8.', ('00F20', '00000100')),
    ('m 7.', ('00F20', '00000080')),
    ('m 6.IMUC0', ('00F20', '00000040')),
    ('m 5.DINT', ('00F20', '00000020')),
    ('m 4.', ('00F20', '00000010')),
    ('m 3.BMS2', ('00F20', '00000008')),
    ('m 2.BMS1', ('00F20', '00000004')),
    ('m 1.BMS0', ('00F20', '00000002')),
    ('m 0.COORD', ('00F20', '00000001')),
    ('e 31.', ('00F27', '80000000')),
    ('e 30.', ('00F27', '40000000')),
    ('e 29.', ('00F27', '20000000')),
    ('e 28.', ('00F27', '10000000')),
    ...
    ('e 18.', ('00F27', '00040000')),
    ('e 17.', ('00F27', '00020000')),
    ('e 16.DCTRLS', ('00F27', '00010000')),
    ('e 15.', ('00F27', '00008000')),
    ('e 14.', ('00F27', '00004000')),
    ('e 13.', ('00F27', '00002000')),
    ('e 12.EM_BATT', ('00F27', '00001000')),
    ('e 11.BBC1', ('00F27', '00000800')),
    ('e 10.BBC0', ('00F27', '00000400')),
    ('e 9.', ('00F27', '00000200')),
    ('e 8.', ('00F27', '00000100')),
    ('e 7.', ('00F27', '00000080')),
    ('e 6.IMUC0', ('00F27', '00000040')),
    ('e 5.DINT', ('00F27', '00000020')),
    ('e 4.', ('00F27', '00000010')),
    ('e 3.BMS2', ('00F27', '00000008')),
    ('e 2.BMS1', ('00F27', '00000004')),
    ('e 1.BMS0', ('00F27', '00000002')),
    ('e 0.COORD', ('00F27', '00000001'))
))
